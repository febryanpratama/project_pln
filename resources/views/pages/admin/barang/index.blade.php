    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <!--begin::Filter menu-->
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">+ Kriteria</a>
            </div>
            <!--end::Actions-->
        </div>
        <!--end::Container-->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_barang" class="form-control @error('nama_barang')
                                        is-invalid
                                    @enderror" value="{{ old('nama_barang') }}"  placeholder="Masukkan Nama Barang" required>
                                </div>
                                @error('nama_barang')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="path_barang" class="form-control @error('path_barang')
                                        is-invalid
                                    @enderror" value="{{ old('path_barang') }}" placeholder="Masukkan Rating Kriteria. Range 1 - 10" required>
                                </div>
                                @error('path_barang')
                                    <div class="text-muted text-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <table id="kt_datatable_example_1" class="table table-row-bordered gy-5">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ asset('') }}uploads/{{ $key->path_barang }}" class="badge badge-primary" target="_blank">Lihat Foto</a>
                                            </td>
                                            <td>
                                        ...
                                        <div class="modal fade" id="hapus{{ $item+1 }}" tabindex="-1" aria-hidden="true">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-500px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <!--begin::Stepper-->
                                                        <form action="{{ route('barang.destroy') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="barang_id" value="{{ $key->id }}">
                                                            <div class="row">
                                                                <p>Apakah anda yakin ingin menghapus Data {{ $key->nama_barang }} ??</p>
                                                            </div>
                                                            <div class="text-center pt-15">
                                                                <button type="reset" data-bs-dismiss="modal" class="btn btn-light me-3">Discard</button>
